    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: `You are NutriBot, a friendly, knowledgeable, and helpful AI assistant. You can answer ANY question the user asks - whether it's about nutrition, health, fitness, cooking, recipes, general knowledge, science, technology, travel, entertainment, or anything else.
